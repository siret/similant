...
def clustering(m, n_clusters):
    ...
    for i in range(n_clusters):
        #subMatrix = results.iloc[results.cluster == i]
        ...
        results["diameter"][cl_users] = cl_diameter
        results["centroid_uid"][cl_users] = cl_centroid
        results["dist_to_centroid"][cl_users] = cl_distances
