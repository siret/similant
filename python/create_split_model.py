...
from similant.split_clustering import process_clustering
...
def main():
    ...
    mapping = None
    if not args["mapping"] is None:
        logging.info("Loading mapping ...")
        mapping = {}
        for mapinfo in load_descriptors(args["mapping"]):
            mapping[mapinfo["id"]] = mapinfo["value"]
...
def read_configuration():
    ...
    parser.add_argument("--mapping",
                        type=str, dest="mapping", required=False,
                        help="Mapping from virtual identifiers to real one.")
